...
from admiral_denver.data.csv.observation_file_reader import ObservationFileReader
from admiral_denver.logger import setup_logger
from admiral_denver.models.sample_point_observation import SamplePointObservation
from admiral_denver.settings import admiral_denver, date_from_file
...
def create_observations() -> None:
    ...
    first_observations_file = admiral_denver.observations_files[0]
    ...
    with open(
        ...
        for observations_file in admiral_denver.observations_files:
...
def create_records() -> None:
    ...
    with open("./data/processed/records.csv", "w+", newline="") as records_file:
        ...
        for survey_file_path in admiral_denver.observations_files:
